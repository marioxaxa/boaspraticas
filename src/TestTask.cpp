...
TestTask::TestTask(std::const string &title, std::const string &description, tm deadline) : Task(title, description, deadline, "TEST") {}

TestTask::TestTask(std::const string &title, std::const string &description) : Task(title, description, "TEST") {}

TestTask::TestTask(std::const string &title) : Task(title, "TEST") {}
...
TestTask::TestTask(std::const string &title, std::const string &description, tm deadline, FeatureTask *feature) : Task(title, description, deadline, "TEST")
{
    this->feature = feature;
}

TestTask::TestTask(std::const string &title, std::const string &description, FeatureTask *feature) : Task(title, description, "TEST")
{
    this->feature = feature;
}

TestTask::TestTask(std::const string &title, FeatureTask *feature) : Task(title, "TEST")
{
    this->feature = feature;
}
